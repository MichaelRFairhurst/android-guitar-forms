...
class FretPatternCollection {
	...
	public FretPatternCollection(SharedPreferences myprefs) {
		...
		if(prefs.getBoolean("pref_eight_note_minor_sweeps", false)) {
			...
			patterns.add(new FretPattern("minor 8 note sweep", chord, 1, new Note("E")));
			...
			chord.add(new Fretting(2, 4));
			chord.add(new Fretting(3, 5));
			patterns.add(new FretPattern("minor 8 note sweep", chord, 2, new Note("E")));
			...
			chord.add(new Fretting(3, 5));
			patterns.add(new FretPattern("minor 8 note sweep", chord, 3, new Note("E")));
			...
			chord.add(new Fretting(7, 4));
			chord.add(new Fretting(7, 5));
			patterns.add(new FretPattern("minor 8 note sweep", chord, 4, new Note("E")));
			...
			chord.add(new Fretting(7, 5));
			patterns.add(new FretPattern("minor 8 note sweep", chord, 5, new Note("E")));
			...
			chord.add(new Fretting(10, 4));
			chord.add(new Fretting(12, 5));
			patterns.add(new FretPattern("minor 8 note sweep", chord, 6, new Note("E")));
		}
		...
		if(prefs.getBoolean("pref_eight_note_major_sweeps", false)) {
			...
			chord.add(new Fretting(0, 5));
			patterns.add(new FretPattern("major 8 note sweep", chord, 1, new Note("E")));
			...
			chord.add(new Fretting(2, 4));
			chord.add(new Fretting(4, 5));
			patterns.add(new FretPattern("major 8 note sweep", chord, 2, new Note("E")));
			...
			chord.add(new Fretting(7, 5));
			chord.add(new Fretting(4, 5));
			patterns.add(new FretPattern("major 8 note sweep", chord, 3, new Note("E")));
			...
			chord.add(new Fretting(7, 4));
			chord.add(new Fretting(7, 5));
			patterns.add(new FretPattern("major 8 note sweep", chord, 4, new Note("E")));
			...
			chord.add(new Fretting(12, 5));
			chord.add(new Fretting(7, 5));
			patterns.add(new FretPattern("major 8 note sweep", chord, 5, new Note("E")));
